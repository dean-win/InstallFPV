...
echo -e "\n\n${RED}By ${CYAN}Dean win${RESET}"
echo -e "${RED} * GitHub ${CYAN}github.com/dean-win/InstallFPV${RESET}"
echo -e "${RED} * Telegram ${CYAN}t.me/shopwin2${RESET}"
echo -e "\n\n\n"
...
#9
if ! git clone --depth 1 https://github.com/NightStrang6r/FunPayVertex ${BOT_PATH}; then
echo -e "${start_process_line}\nПроизошла ошибка при клонировании репозитория FunPayVertex. (9/${commands})\n${end_error_line}"
exit 2
fi
...
clear
echo -e $logo
echo -e '\n\n\e[1;91mBy \e[1;96mDean win\e[0m'
echo -e '\e[1;91m * GitHub \e[1;96mgithub.com/dean-win/InstallFPV\e[0m'
echo -e '\e[1;91m * Telegram \e[1;96mt.me/shopwin2\e[0m'
...
echo -e "Теперь напиши своему Telegram-боту (если ты его включил)."
echo -e "\nДля остановки FPV используй команду \e[93msudo systemctl stop ${service_filename}\e[1;92m"
echo -e "Для запуска FPV используй команду \e[93msudo systemctl start ${service_filename}\e[1;92m"
